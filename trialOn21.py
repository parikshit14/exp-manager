...
cv2.imshow("Original", image_resize(orig, height = 650))
cv2.imshow("Scanned", image_resize(warped, height = 650))
cv2.imwrite("best_one.jpg", image_resize(warped, height = 650))
best_one=cv2.imread("best_one.jpg")
cv2.waitKey(0)
# smooth = cv2.GaussianBlur(warped,(5,5),0)#image_smoothening(warped)
enlarged=image_resize(warped,650)
